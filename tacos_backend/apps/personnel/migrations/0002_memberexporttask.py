# 由 Django 4.2.14 于 2025-10-28 06:50 生成
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to=apps.personnel.models.member_export_task_upload_to,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["expires_at"], name="idx_member_export_expires"
                    ),
                ],
            },
        ),
