...
- `GET /members/` - 获取队员列表
- `POST /members/` - 创建队员档案
- `GET /members/:id/` - 获取队员详情
- `PUT /members/:id/` - 更新队员信息
- `DELETE /members/:id/` - 删除队员档案
- `GET /alumni-profiles/me/` - 获取当前校友信息
- `PATCH /alumni-profiles/me/` - 更新当前校友信息
- `GET /instructors/` - 获取教师列表
- `POST /instructors/` - 创建教师档案
- `GET /instructors/:id/` - 获取教师详情
- `PUT /instructors/:id/` - 更新教师信息
- `DELETE /instructors/:id/` - 删除教师档案

### 谱务管理
- `GET /sheets/` - 获取乐谱列表
- `POST /sheets/` - 上传乐谱
- `GET /sheets/:id/` - 获取乐谱详情
- `PUT /sheets/:id/` - 更新乐谱信息
- `DELETE /sheets/:id/` - 删除乐谱
- `POST /sheets/:id/download/` - 发起乐谱水印下载/预览任务
...
- `PUT /events/:id/` - 更新活动（管理员）
- `DELETE /events/:id/` - 删除活动（管理员）
- `POST /events/:id/join/` - 报名活动（成员）

### 签到系统
- `GET /events/:id/checkin/status/` - 当前签到状态
- `GET /events/:id/checkin/sessions/` - 签到会话列表
- `POST /events/:id/checkin/start/` - 创建签到会话（管理员）
- `POST /events/:id/checkin/begin/` - 开始签到会话（管理员）
- `POST /events/:id/checkin/stop/` - 结束签到会话（管理员）
- `POST /events/:id/checkin/submit/` - 提交签到（成员；支持密码/定位签到）
- `GET /events/:id/checkin/records/` - 签到记录（成员仅看自己，管理员可筛选）
- `DELETE /events/:id/checkin/sessions/:sessionId/` - 删除签到会话

### 作业管理
- `GET /events/:id/assignments/` - 作业列表
- `POST /events/:id/assignments/create/` - 创建作业（管理员）
- `GET /events/:id/assignments/:assignmentId/` - 作业详情
- `PUT /events/:id/assignments/:assignmentId/edit/` - 更新作业（管理员）
- `POST /events/:id/assignments/:assignmentId/attachments/` - 上传作业附件（管理员；支持多文件）
- `POST /events/:id/assignments/:assignmentId/submit/` - 提交作业（成员；支持文本 + 多文件）
- `GET /events/:id/assignments/:assignmentId/submissions/` - 提交列表（管理员可筛选）
- `GET /events/:id/assignments/:assignmentId/my-submission/` - 我的提交（成员）
- `POST /events/:id/assignments/:assignmentId/grade/` - 批改提交（管理员）
...
- **Alumni（校友状态）**
  - 可以维护自己的联系窗口，包括当前城市、行业、公司职位、毕业时间和简介；毕业时间必填，微信、电话、邮箱沿用成员档案
  - 可以查看管理员开放给校友的活动
